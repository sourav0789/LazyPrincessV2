...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://telegram.me/backupmoviezone')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/bdmoviezonepro"),
            ],
            [
...
# paste this code at the bottom of the  commands.py
...
#feel free to share @LazyDeveloperr ❤️
#join main channel @LazyDeveloper 🎉
